...
# vision = true                       # whether models support image input (default: true for Vertex)

[zai]
api_key = ""                          # z.ai API key (required for zai backend)
model = "glm-5.1"
# vision = false                      # whether models support image input (default: false)
...
# vision = true                      # whether models support image input (default: true)
